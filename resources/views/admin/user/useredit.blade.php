                            ...
                            @csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input name="dob" type="date" class="form-control" value="{{$user->dob}}" required>
                                        @error('dob')
                                            <div class="text-danger">{{$message}}</div>
                                            @enderror
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input name="doj" type="date" class="form-control" value="{{$user->doj}}"  required>
                                        @error('doj')
                                            <div class="text-danger">{{$message}}</div>
                                            @enderror
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input name="user_number" type="text" class="form-control" value="{{$user->user_number}}">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input name="ldap_email" type="email" value="{{$user->ldap_email}}"  class="form-control">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label">Sesame Email Address<span class="text-danger">*</span></label>
                                        <input name="sesame_email" type="email" class="form-control" value="{{$user->sesame_email}}"  required>
                                        @error('sesame_email')
                                            <div class="text-danger">{{$message}}</div>
                                            @enderror
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select name="user_language" class="form-select" aria-label="Default select example" id="language">
                                            ...
                                            <option value="{{$lan->code}}" {{$user->user_language == $lan->code  ? 'selected' : ''}}>{{$lan->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <option value="">Select</option>
                                            @foreach ($usertl as $utl)
                                            <option value="{{$utl->id}}" {{$user->usertl == $utl->id  ? 'selected' : ''}}>{{$utl->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select name="location" class="form-select" aria-label="Default select example">
                                            ...
                                            <option value="{{$loc->id}}" {{$user->location == $loc->id  ? 'selected' : ''}}>{{$loc->name}}</option>
                                            @endforeach
                                        </select>
                                        @error('location')
                                            <div class="text-danger">{{$message}}</div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select name="role" class="form-select" aria-label="Default select example">
                                            ...
                                            <option value="{{$userrole->id}}" {{$user->type == $userrole->id  ? 'selected' : ''}}>{{$userrole->title}}</option>
                                            @endforeach
                                        </select>
                                        @error('role')
                                            <div class="text-danger">{{$message}}</div>
